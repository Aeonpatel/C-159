...
america = ImageTk.PhotoImage(Image.open ("America.jpeg"))
australia = ImageTk.PhotoImage(Image.open ("Australia.jpeg"))
philippines = ImageTk.PhotoImage(Image.open ("Phillippines.png"))
japan = ImageTk.PhotoImage(Image.open ("Japan.webp"))
